...
export default function Introduce() {
  return (
    <>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-primary-600 to-primary-800" style={{ paddingTop: '160px', paddingBottom: '80px' }}>
        ...
        <div className="relative mx-auto max-w-[1280px] px-4 sm:px-6" style={{ margin: '0 auto' }}>
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <span className="mb-2 text-sm font-medium text-primary-200" style={{ display: 'block', marginBottom: '8px' }}>About Us</span>
      ...
      {/* ===== 원장님 인사말 ===== */}
      <section style={{ padding: '80px 0' }} id="greeting">
        <div className="mx-auto max-w-[1280px] px-4 sm:px-6" style={{ margin: '0 auto' }}>
          <SectionTitle subtitle="Greeting" title="원장님 인사말" />

          <motion.div {...fadeUp} className="flex flex-col items-start md:flex-row" style={{ gap: '40px' }}>
            ...
            <div className="text-[15px] leading-[1.85] text-text-secondary md:text-base">
              <p style={{ marginBottom: '20px' }}>우리나라는 다른 나라에 비해 특히나 급속히 고령사회로 접어드는 와중에 노인들의 가정, 사회적 소외감 증대, 미흡한 노후 생활비와 건강유지의 어려움이 증폭되면서, 노인문제는 단순히 가족만의 것이 아니라 국가적인 문제로 대두되어, 정부에서는 그 대책으로 2008년 7월 부터 노인장기요양제도를 시행하고 있습니다.</p>
              <p style={{ marginBottom: '20px' }}>이 제도는 국가지원을 바탕으로 노인에 대한 신체활동과 인지능력의 유지, 행동변화 치료와 관리 등을 함으로써, 노인들의 노후생활 안정을 도모하고 보호자 가정의 일상생활 유지를 보장하는 것이 목적입니다.</p>
              <p style={{ marginBottom: '20px' }}>성심노인요양원은 2010년 설립된 정부지정 노인전문 요양기관으로, 전문적인 교육을 받은 사회복지사, 요양보호사들이 이름 그대로 성심과 전문성을 기본으로 정성을 다한 보살핌을 추구하면서, 만족도 높은 다양한 각종 요양  서비스를 제공하고 지속적으로 건강, 질병관리에 심혈을 기울이고 있으며, 시설소개서에서 강조하는 바와 같이 다른 요양원과는 차별화된 입소자를 위한 노인복지 시설입니다.</p>
              <p style={{ marginBottom: '20px' }}>저희 요양원은 경로효친의 실천현장으로 가정과 같은 분위기에서 어르신들의 행복한 쉼터가 되고, 부양가족의 정서적‧경제적 부담을 덜어드리는 안심할 수 있는 요양원이 되도록 혼신의 노력을 다하고 있습니다.</p>
              <p className="font-medium text-text-primary" style={{ marginTop: '32px' }}>감사합니다.</p>
            </div>
          </motion.div>
        </div>
      </section>
      ...
      {/* ===== 시설소개서 ===== */}
      <section className="bg-surface-dim" style={{ padding: '80px 0' }} id="facility">
        <div className="mx-auto max-w-[1280px] px-4 sm:px-6" style={{ margin: '0 auto' }}>
          <SectionTitle subtitle="Facility" title="시설소개서" />

          <motion.div {...fadeUp} className="text-[15px] leading-[1.85] text-text-secondary md:text-base">
            <p style={{ marginBottom: '20px' }}>우리 주변에는 부모님 또는 친지분께서 노인성 질병, 치매, 파킨슨 등으로 혼자서는 일상생활을 수행하기 어려운 분들이 많이 계시고, 이들과 생활하는 가정 구성원에게는 정서적, 시간적으로 큰 부담이 되는 경우가 많습니다.</p>
            <p style={{ marginBottom: '40px' }}>저희 요양원은 정부지정 노인전문 요양기관으로, 24시간 어르신과 함께 생활하며 숙식, 목욕, 위생, 산책 등 일상생활 지원서비스를 제공하고 있으며, 아래와 같이 다른 요양원과는 차별화된 입소자를 위한 노인복지 시설입니다.</p>

            <div className="rounded-2xl bg-white shadow-sm" style={{ padding: '32px 24px', margin: '40px 0', display: 'flex', flexDirection: 'column', gap: '20px' }}>
              <div className="flex items-start" style={{ gap: '12px' }}>
                <span className="shrink-0 rounded bg-primary-100 px-2 py-0.5 text-xs font-bold text-primary-700" style={{ marginTop: '4px' }}>01</span>
              ...
              <div className="flex items-start" style={{ gap: '12px' }}>
                <span className="shrink-0 rounded bg-primary-100 px-2 py-0.5 text-xs font-bold text-primary-700" style={{ marginTop: '4px' }}>02</span>
              ...
              <div className="flex items-start" style={{ gap: '12px' }}>
                <span className="shrink-0 rounded bg-primary-100 px-2 py-0.5 text-xs font-bold text-primary-700" style={{ marginTop: '4px' }}>03</span>
              ...
              <div className="flex items-start" style={{ gap: '12px' }}>
                <span className="shrink-0 rounded bg-primary-100 px-2 py-0.5 text-xs font-bold text-primary-700" style={{ marginTop: '4px' }}>04</span>
            ...
            <p style={{ marginTop: '40px' }}>또한 미용봉사 등 노력 봉사자분들께서 어르신 케어에 많은 도움을 주고 계시며, 입소 어르신들의 정서적 성장과 안정을 위해 종교활동도 지원하고 있습니다.</p>
          </motion.div>
        </div>
      </section>

      {/* ===== 이용대상자 및 시설규모 ===== */}
      <section style={{ padding: '80px 0' }} id="info">
        <div className="mx-auto max-w-[1280px] px-4 sm:px-6" style={{ margin: '0 auto' }}>
          <SectionTitle subtitle="Information" title="성심노인요양원 이용대상자 및 시설의 규모" />

          <motion.div {...fadeUp} className="text-center" style={{ marginBottom: '24px' }}>
            <p className="inline-block rounded-xl bg-primary-50 text-sm font-medium text-primary-700 md:text-base" style={{ padding: '12px 20px' }}>
              <strong>이용 대상자 :</strong> 장기요양 등급 1등급 ~ 5등급 판정을 받으신 어르신
            </p>
            <p className="text-sm text-text-secondary" style={{ marginTop: '8px' }}>
              (3등급 ~ 5등급의 경우에는 급여종류에 시설급여가 포함되어 있어야 합니다).
            </p>
          </motion.div>

          <motion.div {...fadeUp} style={{ padding: '0 16px' }}>
            <div style={{ borderRadius: '16px', border: '1px solid #E5E7EB', overflow: 'hidden', boxShadow: '0 10px 25px -5px rgba(0, 0, 0, 0.05), 0 8px 10px -6px rgba(0, 0, 0, 0.01)' }}>
              <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left', backgroundColor: '#FFFFFF' }}>
                <tbody>
                  {facilityInfo.map((row, idx) => (
                    <tr key={idx} style={{ borderBottom: idx === facilityInfo.length - 1 ? 'none' : '1px solid #F1F5F9', transition: 'background-color 0.2s' }}>
                      <th style={{ width: '25%', padding: '24px 32px', backgroundColor: '#F8FAFC', color: '#1E293B', fontWeight: '700', fontSize: '15px', borderRight: '1px solid #F1F5F9', whiteSpace: 'nowrap' }}>
                        {row.label}
                      </th>
                      <td style={{ padding: '24px 32px', color: '#475569', fontSize: '15px', lineHeight: '1.75', whiteSpace: 'pre-line' }}>
                        {row.value}
                      </td>
                    </tr>
                  ))}
      ...
      <section style={{ padding: '80px 0' }}>
        <div className="px-4 sm:px-6" style={{ maxWidth: '1280px', margin: '0 auto' }}>
      ...
      <section className="bg-surface-dim" style={{ padding: '80px 0' }}>
        <div className="px-4 sm:px-6" style={{ maxWidth: '1280px', margin: '0 auto' }}>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5" style={{ gap: '24px' }}>
            {programs.map((prog, idx) => (
              ...
              >
                ...
                <div style={{ padding: '20px 16px' }}>
                  <h4 className="text-sm font-bold text-text-primary" style={{ marginBottom: '8px' }}>{prog.title}</h4>
      ...
      {/* ===== 요양생활 사진 (갤러리) ===== */}
      <section className="bg-surface-dim" style={{ padding: '80px 0' }} id="gallery">
        <div className="px-4 sm:px-6" style={{ maxWidth: '1280px', margin: '0 auto' }}>
