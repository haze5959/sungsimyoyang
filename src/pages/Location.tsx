    ...
    <>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-primary-600 to-primary-800 pt-28 pb-16 md:pt-36 md:pb-20">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6">
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <span className="mb-2 text-sm font-medium text-primary-200">Location</span>
      ...
      <section className="py-16 md:py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          ...
          {/* 카카오맵 임베드 */}
          <motion.div {...fadeUp} className="mb-8 overflow-hidden rounded-2xl shadow-lg">
            <iframe
          ...
          {/* 교통 안내 */}
          <motion.div {...fadeUp} className="rounded-2xl border border-primary-100/50 bg-white p-6 shadow-sm md:p-8">
            <div className="flex items-start gap-4">
              <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-primary-50 text-primary-500">
                <Navigation size={24} />
              </div>
              <div>
                <h3 className="mb-2 text-lg font-bold text-text-primary">교통 안내</h3>
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-2">
            <motion.div {...fadeUp} className="card-hover rounded-2xl border border-primary-100/50 bg-white p-6 shadow-sm">
              <div className="mb-3 flex h-10 w-10 items-center justify-center rounded-xl bg-primary-50 text-primary-500">
                <MapPin size={20} />
              </div>
              <p className="mb-1 text-xs font-medium text-text-muted">주소</p>
            ...
            <motion.div {...fadeUp} className="card-hover rounded-2xl border border-primary-100/50 bg-white p-6 shadow-sm">
              ...
              <p className="mb-1 text-xs font-medium text-text-muted">연락처</p>
              <p className="text-sm font-semibold text-text-primary">
